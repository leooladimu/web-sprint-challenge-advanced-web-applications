...
export const handlers = [
  ...
  rest.get('http://localhost:3000/api/articles', getAll),
  rest.get('http://localhost:3000/api/articles/:id', getById),
  rest.post('http://localhost:3000/api/articles', create),
  rest.put('http://localhost:3000/api/articles/:id', edit),
  rest.delete('http://localhost:3000/api/articles/:id', remove)
]